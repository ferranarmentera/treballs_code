...
class Tolerance():
    ...
    def __init__(self,  quality, mat, dimension=1, cav=1):
...
def form_complete(values, placement, length):
    ...
    while len(placement) < length:
        ...
        value = Tolerance(dimension, mat, cav, quality)
...
if __name__ == '__main__':
    ...
    Tolerance = form_complete('Tolerance', 'length', 2)
    for self in range(len(Tolerance)):
